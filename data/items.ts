export const BattleItems: {[itemid: string]: ItemData} = {
	...
	aerodactylite: {
		...
		itemUser: ["Aerodactyl", "aerodactyl"],
		onTakeItem(item, source) {
			if (item.megaEvolves === source.baseSpecies.baseSpecies) return false;
			return true;
		},
	...
	kangaskhanite: {
		...
		itemUser: ["Kangaskhan", "kangaskhan"],
		onTakeItem(item, source) {
			if (item.megaEvolves === source.baseSpecies.baseSpecies) return false;
			return true;
		},
